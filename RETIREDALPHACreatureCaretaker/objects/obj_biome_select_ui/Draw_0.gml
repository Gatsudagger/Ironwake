...
for (var _i = 0; _i < BIOME.COUNT; _i++) {
    ...
    // Card base — procedural biome background + dark overlay on top 75% for readability
    scr_draw_biome_background(_i, _cx, cards_y, card_w, card_h);
    draw_set_alpha(0.55);
    draw_set_colour(make_colour_rgb(8, 10, 20));
    draw_rectangle(_cx, cards_y, _cx + card_w, cards_y + card_h * 0.75, false);
    draw_set_alpha(1.0);
