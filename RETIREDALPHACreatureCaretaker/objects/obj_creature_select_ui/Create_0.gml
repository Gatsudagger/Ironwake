...
var cards_visible = 5;
scroll_offset = 0;
scroll_max    = SPECIES.COUNT - cards_visible;

// Card layout — sized for 5 visible cards
card_w   = 240;
card_h   = 340;
card_gap = 14;
var total_w  = cards_visible * card_w + (cards_visible - 1) * card_gap;
...
creature_desc = [
	...
	["Armored shell-striker",   "High DEF & STR",      "Relentless tank"    ],  // Thornback
	["Luminous moth spirit",    "High INT & WIL",      "Mystic radiance"    ],  // Glowmoth
];
...
icon_col = [
	...
	make_colour_rgb(70,  90,  60),   // Thornback  — muted olive green
	make_colour_rgb(140, 80,  180),  // Glowmoth   — soft purple
];
