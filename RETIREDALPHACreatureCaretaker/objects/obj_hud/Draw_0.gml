...
// Biome color tint (subtle environment atmosphere)
var _btints = [
    make_colour_rgb(120, 160, 220),  // ALPINE_FOREST  - cool blue
    make_colour_rgb(80,  150,  70),  // TEMPERATE_FOREST - green
    make_colour_rgb(50,  160,  60),  // JUNGLE - deep green
    make_colour_rgb(200, 160,  80),  // OASIS  - warm sandy
    make_colour_rgb(150, 130, 100),  // MOUNTAIN_VALLEY - stone
];
var _bid = clamp(obj_game_controller.biome_id, 0, 4);
draw_set_alpha(0.12);
draw_set_colour(_btints[_bid]);
