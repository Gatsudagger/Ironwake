...
global.__sprite_includes = [
    // 09-10 forge / seashell icons (stash MISC rows resolve them by asset_get_index string)
    spr_icon_forge_runeheart_core, spr_icon_forge_mythril_frame, spr_icon_valuable_seashell,
    // 09-03 THE SEAHORSE KNIGHT (all resolved by asset_get_index string)
    spr_seahorse_knight,
    spr_event_splash_seahorse_knight,
    spr_pet_egg_tidal,
    spr_pet_egg_tidal_hatch,
    spr_npc_seahorse_knight_idle,
    // Hippocamp pet lines (Guardian teal = hippocamp, Warrior navy/pink = hippocamp_w)
    spr_pet_hippocamp_baby_s,         spr_pet_hippocamp_baby_e,
    spr_pet_hippocamp_youngadult_s,   spr_pet_hippocamp_youngadult_e,
    spr_pet_hippocamp_w_baby_s,       spr_pet_hippocamp_w_baby_e,
    spr_pet_hippocamp_w_youngadult_s, spr_pet_hippocamp_w_youngadult_e,
    spr_pet_hippocamp_adult_s,        spr_pet_hippocamp_adult_e,
    spr_pet_hippocamp_w_adult_s,      spr_pet_hippocamp_w_adult_e,
    // 09-02 biome enemy art run (variants resolve _ff2/_ff3 by string)
    spr_first_door_ff,
    spr_first_door_ff2,
    spr_first_door_ff3,
    spr_sister_fathom_ff,
    spr_sister_fathom_ff2,
    spr_sister_fathom_ff3,
    spr_the_tally_ff,
    spr_the_tally_ff2,
    spr_the_tally_ff3,
    spr_hollowlight_ff,
    spr_hollowlight_ff2,
    spr_hollowlight_ff3,
    spr_weight_of_ironwake_ff,
    spr_weight_of_ironwake_ff2,
    spr_weight_of_ironwake_ff3,
    spr_long_arithmetic_ff,
    spr_long_arithmetic_ff2,
    spr_long_arithmetic_ff3,
    spr_nothing_in_particular_ff,
    spr_nothing_in_particular_ff2,
    spr_nothing_in_particular_ff3,
    spr_the_understudy_ff,
    spr_the_understudy_ff2,
    spr_the_understudy_ff3,
    spr_hollow_crown_ff,
    spr_hollow_crown_ff2,
    spr_hollow_crown_ff3,
    spr_the_bottom_ff,
    spr_the_bottom_ff2,
    spr_the_bottom_ff3,
    // 09-02 biome backgrounds (dungeon_bg_sprite resolves by string)
    spr_combatbg_drowned_1,
    spr_combatbg_drowned_2,
    spr_combatbg_drowned_3,
    spr_floormap_drowned,
    spr_combatbg_canopy_1,
    spr_combatbg_canopy_2,
    spr_combatbg_canopy_3,
    spr_floormap_canopy,
    // 09-02 biome enemy art run (variants resolve _ff2/_ff3 by string)
    spr_drowned_deckhand_ff,
    spr_drowned_deckhand_ff2,
    spr_drowned_deckhand_ff3,
    spr_barnacle_thrall_ff,
    spr_barnacle_thrall_ff2,
    spr_barnacle_thrall_ff3,
    spr_silt_wraith_ff,
    spr_silt_wraith_ff2,
    spr_silt_wraith_ff3,
    spr_anchor_revenant_ff,
    spr_anchor_revenant_ff2,
    spr_anchor_revenant_ff3,
    spr_deepwater_sentinel_ff,
    spr_deepwater_sentinel_ff2,
    spr_deepwater_sentinel_ff3,
    spr_the_long_drink_ff,
    spr_the_long_drink_ff2,
    spr_the_long_drink_ff3,
    spr_tide_crawler_ff,
    spr_tide_crawler_ff2,
    spr_tide_crawler_ff3,
    spr_kelp_hound_ff,
    spr_kelp_hound_ff2,
    spr_kelp_hound_ff3,
    spr_bloatling_ff,
    ...
    spr_choirmother_ff2,
    spr_choirmother_ff3,
    spr_leviathan_below_ff,
    spr_leviathan_below_ff2,
    spr_leviathan_below_ff3,
    spr_the_tidewright_ff,
    spr_the_tidewright_ff2,
    spr_the_tidewright_ff3,
    spr_bramble_husk_ff,
    spr_bramble_husk_ff2,
    spr_bramble_husk_ff3,
    spr_pale_fisher_ff,
    spr_pale_fisher_ff2,
    spr_pale_fisher_ff3,
    spr_rootbound_corpse_ff,
    spr_rootbound_corpse_ff2,
    spr_rootbound_corpse_ff3,
    spr_spore_moth_ff,
    spr_spore_moth_ff2,
    spr_spore_moth_ff3,
    spr_thicket_boar_ff,
    spr_thicket_boar_ff2,
    spr_thicket_boar_ff3,
    spr_witchwood_sapling_ff,
    spr_witchwood_sapling_ff2,
    spr_witchwood_sapling_ff3,
    spr_canopy_stalker_ff,
    spr_canopy_stalker_ff2,
    spr_canopy_stalker_ff3,
    spr_grafted_knight_ff,
    spr_grafted_knight_ff2,
    spr_grafted_knight_ff3,
    spr_grafted_stag_ff,
    spr_grafted_stag_ff2,
    spr_grafted_stag_ff3,
    spr_hollow_nester_ff,
    spr_hollow_nester_ff2,
    spr_hollow_nester_ff3,
    spr_moss_wraith_ff,
    spr_moss_wraith_ff2,
    spr_moss_wraith_ff3,
    spr_old_growth_ff,
    ...
    spr_sporemind_ff2,
    spr_sporemind_ff3,
    spr_mother_bramble_ff,
    spr_mother_bramble_ff2,
    spr_mother_bramble_ff3,
    spr_green_silence_ff,
    spr_green_silence_ff2,
    spr_green_silence_ff3,
    spr_sunken_chorister_ff,
    spr_sunken_chorister_ff2,
    spr_sunken_chorister_ff3,
    spr_pyre_dancer_ff,
    spr_pyre_dancer_ff2,
    spr_pyre_dancer_ff3,
    spr_rustkeeper_ff,
    ...
    spr_rustkeeper_ff3,
    spr_second_count_ff,
    spr_second_count_ff2,
    spr_second_count_ff3,
    spr_candle_thief_ff,
    spr_candle_thief_ff2,
    spr_candle_thief_ff3,
    spr_slagback_tortoise_ff,
    spr_slagback_tortoise_ff2,
    spr_slagback_tortoise_ff3,
    spr_the_unquenched_ff,
    spr_the_unquenched_ff2,
    spr_the_unquenched_ff3,
    spr_mourner_in_ice_ff,
    spr_mourner_in_ice_ff2,
    spr_mourner_in_ice_ff3,
    spr_barrow_wight_ff,
    spr_barrow_wight_ff2,
    spr_barrow_wight_ff3,
    spr_cortege_bearer_ff,
    spr_cortege_bearer_ff2,
    spr_cortege_bearer_ff3,
    ...
    // 09-02 Drowned / Canopy plane pairs (string-looked-up in dungeon_bg_draw)
    spr_wall25_drowned_1, spr_floor25_drowned_1, spr_wall25_drowned_2, spr_floor25_drowned_2, spr_wall25_drowned_3, spr_floor25_drowned_3, spr_wall25_canopy_1, spr_floor25_canopy_1, spr_wall25_canopy_2, spr_floor25_canopy_2, spr_wall25_canopy_3, spr_floor25_canopy_3,
